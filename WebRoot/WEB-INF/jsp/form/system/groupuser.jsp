...
<spring:url value="/sys/group/member/add.do" var="add" />
<spring:url value="/sys/group/member/remove.do" var="del" />
...
<div class="row">
	<form:form commandName="GroupForm" action="form.do">
...
<spring:url value="/sys/group/member/ajax.do" var="getPartyURL">
	<spring:param name="groupId">${GroupForm.groupId }</spring:param>
</spring:url>
<spring:url value="/helper/user.do" var="getUserURL" />
<script type="text/javascript">
	var accessCode = Number('${GroupForm.accessCode}');
	var emptable;

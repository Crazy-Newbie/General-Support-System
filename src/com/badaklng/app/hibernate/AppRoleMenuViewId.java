...
/**
 * AppRoleMenuViewId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class AppRoleMenuViewId extends BaseModel implements java.io.Serializable {
	...
	/** default constructor */
	public AppRoleMenuViewId() {
	}

	/** full constructor */
	public AppRoleMenuViewId(String roleId, Integer menuId) {
		this.roleId = roleId;
		this.menuId = menuId;
	}
	...
	@Column(name = "MENU_ID", precision = 0)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AppRoleMenuViewId))
			return false;
		AppRoleMenuViewId castOther = (AppRoleMenuViewId) other;

...
@Entity
@Table(name = "APP_SUB_EMP_LKP_VIEW")

public class AppSubEmpLkpView extends BaseModel implements java.io.Serializable {
	...
	/** default constructor */
	public AppSubEmpLkpView() {
	}

	/** minimal constructor */
	public AppSubEmpLkpView(String emplid) {
		this.emplid = emplid;
	}

	/** full constructor */
	public AppSubEmpLkpView(String emplid, String nameDisplay, String deptId, String deptDesc, String sectionId,

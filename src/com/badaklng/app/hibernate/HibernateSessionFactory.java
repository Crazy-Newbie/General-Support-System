...
public class HibernateSessionFactory {
	...
	private static final ThreadLocal<StatelessSession> threadLocalStateless = new ThreadLocal<StatelessSession>();
...
//	}
	...
	public static StatelessSession getStatelessSession() {
		StatelessSession session = (StatelessSession) threadLocalStateless.get();

		if (session == null) {
			if (sessionFactory == null)
				rebuildSessionFactory();
			session = (sessionFactory != null) ? sessionFactory.openStatelessSession() : null;
			threadLocalStateless.set(session);
		}
